...
//  const [wrongMcq, setWrongMcq]= useState(0)
  ...
  {
    questions.map(({_id, questionType, question, answers, imageUrl}, index)=>(
    <div key={_id}><h2>{index+=1}. {imageUrl && <div> <img src={imageUrl} width='100px' height='100px' /> </div>} {question}</h2><br/><div>{
